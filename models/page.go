...
type Page struct {
	...
	ReadCount   int64  `json:"readCount" gorm:"type:int(8);NOT NULL;DEFAULT '50'"`    // 读数
...
func CreatePage(title, author, abstract, content string, contentType uint) error {
	page := Page{Title: title, Author: author, Abstract: abstract, Content: content, ContentType: contentType, Type: 1}
